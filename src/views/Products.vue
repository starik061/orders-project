<template>
  <div class="products-container">
    <div v-if="loadingGlobal" class="spinner-container">
    ...
    <div v-else-if="error" class="error-message">
      ...
      <div>
        ...
        <p>{{ error }}</p>
        <button class="retry-button" @click="retryLoading">Попробовать снова</button>
      </div>
    </div>
    <ProductForm v-else :products="allProducts" :orders="orders" :is-empty-state="!allProducts.length"
      @product-deleted="handleProductDeleted" @delete-error="handleDeleteError" />
  </div>
</template>
